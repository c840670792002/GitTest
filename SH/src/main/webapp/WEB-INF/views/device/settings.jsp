...
<div class="headerwrapper">
	<div class="header">
		...
		<div class="tools" <c:if test="${userProfile.channel eq '02'}">style="display:none"</c:if> >
...
<div class="menber" <c:if test="${userProfile.channel eq '02'}">style="display:none"</c:if>><a href="<spring:message code="home.url" />" class="btnsmarthome">回全能行動管家首頁</a><a href="javascript:logout();">您好，${userProfile.nickName}│登出</a></div>
<div class="content">
