...
import com.fet.crm.smarthome.mware.client.impl.FakeSIGClientImpl;
...
public class SIGCustomerServiceImpl implements CustomerService {
    ...
    public CustomerVO getSubscriberIdByMsisdn(final String msisdn) throws BusinessException {
    	FakeSIGClientImpl sig = new FakeSIGClientImpl();
        final MsisdnKeysVo keysVO = sig.retvKeysByMsisdn(msisdn);
