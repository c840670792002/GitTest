...
/**
 * <p>Java class for ValidTimePeriod complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ValidTimePeriod">
 *   &lt;complexContent>
...
@XmlType(name = "ValidTimePeriod", propOrder = {
    "effectiveDate",
    "expirationDate"
})
public class ValidTimePeriod {

    @XmlElementRef(name = "effectiveDate", namespace = "http://www.tibco.com/schemas/CRM-Billing/SharedResources/XSD/Base/Imported/Schema.xsd", type = JAXBElement.class)
    protected JAXBElement<XMLGregorianCalendar> effectiveDate;
    @XmlElementRef(name = "expirationDate", namespace = "http://www.tibco.com/schemas/CRM-Billing/SharedResources/XSD/Base/Imported/Schema.xsd", type = JAXBElement.class)
